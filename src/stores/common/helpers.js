...
export const pdfTemplates = {invoice: 'invoice', payslip: 'payslip'}
...
export const employeeRoutes = [
  ...
  {
    path: paths.EMPLOYEE_LEAVES,
    icon: 'OutlineLogoutIcon',
    name: 'Leave Management'
  },
  {
    path: paths.EMPLOYEE_CHANGE_PASSWORD,
    icon: 'KeyIcon',
...
export const LEAVE_TYPES = [
  {name: 'Casual Leave', type: 'casual_leave'},
  {name: 'Sick Leave', type: 'sick_leave'},
  {name: 'Emergency Leave', type: 'emergency_leave'},
  {name: 'Other Leave', type: 'other_leave'}
]
